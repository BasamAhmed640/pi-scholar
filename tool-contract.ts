...
export const ScholarParams = Type.Object({
  ...
  sectionId: Type.Optional(Type.String({ description: "For Learn notes, omit to use the active frozen section. An explicit value must match its internal ID or displayed section number." })),
