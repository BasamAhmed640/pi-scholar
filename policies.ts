...
- After the lesson is saved, ask exactly 3 short questions, one at a time, with grounding purpose=mastery. The learner answers in Pi: a choice, a number, or one short sentence. Diagnostic questions do not count toward the three; only mastery questions do. Mix kinds (conceptual, computation, application) as the section allows.
